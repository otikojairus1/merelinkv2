    ...
    const fetchProject = async () => {
      try {
        ...
        const response = await axios.get(
          `${BASE_URI}/api/projects/${projectId}`,
          {
            headers: {
        ...
        if (response.data) {
          ...
          setContactPerson(project.contact_person || "");
          ...
          setFunding(project.funding ? project.funding.toString() : "");
          setFoodlbs(project.foodlbs ? project.foodlbs.toString() : "");
          setMediaLink(project.mediaLink || "");

          // Set country code if country is available
          if (project.country) {
            // This would require a mapping from country name to country code
